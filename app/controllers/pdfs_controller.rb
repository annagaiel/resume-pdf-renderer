  ...
  def show
    ...
    respond_to do |format|
      ...
      format.pdf do
        ...
        ", size: 33, font: "Helvetica", color: "0000FF", align: :center 
        # url = "https://robohash.org/istevelitsit.png?size=300x300&set=set1"
...
# #   def header
# #     image ("https://robohash.org/istevelitsit.png?size=300x300&set=set1"), width: 530, height: 150
# #   end
# # end
